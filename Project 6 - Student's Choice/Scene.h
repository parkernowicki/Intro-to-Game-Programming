...
public:
	...
	Mix_Chunk *hurt, *schwing, *bossdead, *warp;

	GLuint backgroundTextureID, fontTextureID, livesTextureID, fJewelIconTextureID, mJewelIconTextureID, rJewelIconTextureID;
